...
class TestMinimumSubstringsInPartition(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        solution_file = f'3144. Minimum Substring Partition of Equal Character Frequency{FILE_EXTENSION}.txt'
    ...
    def run_tests(self):
        ...
        for i, (input_data, expected_output) in enumerate(test_cases, 1):
            ...
            result = self.solution.minimumSubstringsInPartition(input_data)
    ...
    def test_minimum_substrings(self):
