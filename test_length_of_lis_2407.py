...
class TestLengthOfLIS(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        solution_file = f'2407. Longest Increasing Subsequence II{FILE_EXTENSION}.txt'
    ...
    def run_tests(self):
        ...
        # Define the test cases: input_data, k, and expected output
        test_cases = [
        ...
        for i, (input_data, k, expected_output) in enumerate(test_cases, 1):
            start_time = time.perf_counter()  # Start timing
            result = self.solution.lengthOfLIS(input_data, k)
