...
class TestMedianOfUniquenessArray(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        # Define the solution file name using the FILE_EXTENSION variable
        solution_file = f'3134. Find the Median of the Uniqueness Array{FILE_EXTENSION}.txt'
    ...
    def run_tests(self):
        ...
        for i, (input_data, expected_output) in enumerate(test_cases, 1):
            ...
            result = self.solution.medianOfUniquenessArray(input_data)
