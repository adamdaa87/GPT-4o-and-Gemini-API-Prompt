...
class TestFindAllConcatenatedWordsInADict(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        # Define the solution file name using the FILE_EXTENSION variable
        solution_file = f'472. Concatenated Words{FILE_EXTENSION}.txt'
    ...
    def run_tests(self):
        ...
        for i, (input_data, expected_output) in enumerate(test_cases, 1):
            ...
            result = self.solution.findAllConcatenatedWordsInADict(input_data)
            ...
            # Sort both result and expected_output before comparing
            try:
    ...
    def test_find_all_concatenated_words_in_a_dict(self):
