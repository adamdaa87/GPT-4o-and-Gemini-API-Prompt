...
class TestCountRectangles(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        solution_file = f'2250. Count Number of Rectangles Containing Each Point{FILE_EXTENSION}.txt'
    ...
    def run_tests(self):
        ...
        # Define the test cases: rectangles, points, and expected output
        test_cases = [
        ...
        for i, (rectangles, points, expected_output) in enumerate(test_cases, 1):
            start_time = time.perf_counter()  # Start timing
            result = self.solution.countRectangles(rectangles, points)
